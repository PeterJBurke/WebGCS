...
• Total Updates Collected: 283
• Telemetry Samples: 283
...
✅ PASSED TEST-PFD-000: Server Health (0.00s)
   Server healthy. Status: {'drone_connected': False, 'status': 'healthy', 'timestamp': 1757272621.294764}

❌ FAILED TEST-PFD-001: Drone Connection (30.16s)
